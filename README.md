...
### 🌟 Live Interactive Portfolio / Canlı Portfolyo Web Uygulaması
> **Tüm projelerimi, canlı deneyimlerimi ve teknik yeteneklerimi incelemek için tıklayın:**  
> 🚀 **[https://mmerve1.github.io/portfolio/](https://mmerve1.github.io/portfolio/)** 🚀
...
- 🎯 **Specialization:** Microservices Architecture, RESTful API Design, Enterprise IoT Platforms, Secure OAuth2/JWT Authentication, Full-Stack Web & Native Mobile Development.

---

## 🛠️ Languages & Tools / Teknolojiler & Araçlar
...
- 🌐 **[EventHub – Event Management Platform](https://mmerve1.github.io/portfolio/)** — Microservice architecture event creation, booking, and recommendation system (React, Node.js, Express, PostgreSQL).
- ⚡ **[Dynamic Priority Stock Engine](https://mmerve1.github.io/portfolio/)** — Multithreaded transaction prioritization and inventory logging system (Node.js, Express, PostgreSQL).
- 🎮 **[Kelime Mayınları (Word Mines Game)](https://github.com/mmerve1/Kelime-Mayinlari)** — Native Android game built with Kotlin & Jetpack Compose declarative UI architecture.
...
<p align="left">
  <a href="https://www.linkedin.com/in/meerveozdemir/" target="_blank">
  ...
  <a href="mailto:merve.ozdemir1441@gmail.com">
    <img src="https://img.icons8.com/ios-glyphs/60/00f2fe/new-post.png" alt="email" width="45" height="45"/>
  </a>
</p>
